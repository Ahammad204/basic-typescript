...
data = 42;
data.toUpperCase(); // এখানে TypeScript কোনো error দেয় না
...
1. TypeScript type checking করা বন্ধ করে দেয়
...
data.toUpperCase(); // TypeScript এখানে error দেবে
                   // কারণ এখানে string type define করা নাই
```
...
এখানে `typeof` ব্যবহার করে আমরা বলছি:
- `data` আসলে একটি string
- এরপর TypeScript allow করলো string methods ব্যবহার করতে
